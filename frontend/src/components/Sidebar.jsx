...
export default function Sidebar() {
  ...
  return (
    <div className="min-h-screen bg-bg flex">
      <aside className="w-64 bg-bg p-5 flex flex-col min-h-[150vh] font-[Cairo] overflow-y-auto scroll-smooth">
...
<span className="text-[14px] leading-[21px] font-bold "   style={{ color: "var(--color-grey)" }}
>تسجيل الخروج</span>
          </button>
        </div>
